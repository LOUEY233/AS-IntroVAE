...
def Train_SVAE(dataset='cifar10', z_dim=128, lr_d=2e-4, lr_g=2e-4, batch_size=128, num_workers=4,
    ...
    name = 'S_VAE'
    fig_dir = './results/SVAE/figures_' + dataset
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        for batch in pbar:
            ...
            if epoch < num_vae:
                ...
                if cur_iter % 50 == 0:
                    print("lossE fake:{},lossE real:{}".format(lossE_fake,lossE_real))
                optimizer_d.zero_grad()
                lossE.backward()
                optimizer_d.step()
...
if __name__ == '__main__':
    ...
    try:
        Train_SVAE(dataset="monsters128", z_dim=128, batch_size=16, num_workers=0, num_epochs=400,
